...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fetchPlanets: () => (/* binding */ fetchPlanets)
/* harmony export */ });
...
const toasts = new _toast__WEBPACK_IMPORTED_MODULE_0__.Toasts({
  offsetX: 20, // 20px
  offsetY: 20, // 20px
...
const getApiKey = async () => {
  try {
    const { data } = await (0,axios__WEBPACK_IMPORTED_MODULE_1__["default"])({
      method: "post",
      baseURL: BASE_URL,
      url: "/keys",
      headers: {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   applyOverlayContent: () => (/* binding */ applyOverlayContent),
...
function applyOverlayContent(planet) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   planetEventListener: () => (/* binding */ planetEventListener),
/* harmony export */   renderPlanets: () => (/* binding */ renderPlanets)
/* harmony export */ });
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api */ "./src/api.js");
/* harmony import */ var _overlay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./overlay */ "./src/overlay.js");
/* harmony import */ var _toast__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./toast */ "./src/toast.js");
"use-strict";
...
// This is for the feedback/error if something goes wrong.
const toasts = new _toast__WEBPACK_IMPORTED_MODULE_2__.Toasts({
  offsetX: 20, // 20px
  offsetY: 20, // 20px
  gap: 20, // The gap size in pixels between toasts
  width: 300, // 300px
...
async function renderPlanets() {
  try {
    ...
    const array = await (0,_api__WEBPACK_IMPORTED_MODULE_0__.fetchPlanets)();
...
async function planetEventListener(e) {
  const planetName = e.target.classList[1];
  const planetsArray = await (0,_api__WEBPACK_IMPORTED_MODULE_0__.fetchPlanets)();
  const planet = planetsArray.find((el) => el.name === planetName);
  (0,_overlay__WEBPACK_IMPORTED_MODULE_1__.applyOverlayContent)(planet);
}
...
/* harmony export */   checkPlanetName: () => (/* binding */ checkPlanetName)
/* harmony export */ });
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api */ "./src/api.js");
/* harmony import */ var _toast__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./toast */ "./src/toast.js");
"use-strict";
...
// This is for the feedback/error if something goes wrong.
const toasts = new _toast__WEBPACK_IMPORTED_MODULE_1__.Toasts({
  offsetX: 20, // 20px
  offsetY: 20, // 20px
  gap: 20, // The gap size in pixels between toasts
  width: 300, // 300px
...
function autocomplete(inp, arr = searchArray) {
...
async function checkPlanetName(search_query) {
  if (!search_query) {
    toasts.push({
...
/* harmony import */ var _overlay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./overlay */ "./src/overlay.js");
/* harmony import */ var _renderplanets__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./renderplanets */ "./src/renderplanets.js");
...
window.addEventListener("DOMContentLoaded", async () => {
  await (0,_renderplanets__WEBPACK_IMPORTED_MODULE_2__.renderPlanets)();
  const allPlanets = document.querySelectorAll(".planet-container");

  allPlanets.forEach((planet) => {
    planet.addEventListener("click", _renderplanets__WEBPACK_IMPORTED_MODULE_2__.planetEventListener);
  });
});

// This is for closing the overlay/side-page when the user clicks on the X - icon
close__btn.addEventListener("click", _overlay__WEBPACK_IMPORTED_MODULE_1__.toggleOverlay);

// This is for the autocomplete search of the planets
(0,_search__WEBPACK_IMPORTED_MODULE_3__.autocomplete)(input);
...
search__btn.addEventListener("click", async () => {
  const hasPlanet = await (0,_search__WEBPACK_IMPORTED_MODULE_3__.checkPlanetName)(input.value);

  if (hasPlanet.hasPlanet) {
    (0,_overlay__WEBPACK_IMPORTED_MODULE_1__.applyOverlayContent)(hasPlanet.planetFound);
    input.textContent = "";
    input.value = "";
  }
});
